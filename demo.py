...
if __name__ == '__main__':
    ...
    input_dim = 2048
    num_hashtables = 1
    img_dir = 'ImageRetrieval/data'
    test_img_dir = 'ImageRetrieval/data/2020-05-12/zhuben'
    network = 'ImageRetrieval/Image-retrieval-master/weights/gl18-tl-resnet50-gem-w-83fdc30.pth'
    out_similar_dir = 'ImageRetrieval/RepNet-MDNet-VehicleReID-master/output/similar'
    out_similar_file_dir = 'ImageRetrieval/RepNet-MDNet-VehicleReID-master/output/similar_file'
    all_csv_file = 'ImageRetrieval/RepNet-MDNet-VehicleReID-master/output/aaa.csv'
